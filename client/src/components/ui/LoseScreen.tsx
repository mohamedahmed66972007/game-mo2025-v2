      ...
      <Card className="w-full max-w-2xl mx-4 bg-gradient-to-br from-indigo-900/90 to-purple-900/90 border-red-500 shadow-2xl backdrop-blur-sm">
        <CardHeader className="pb-4">
          <div className="text-center">
            ...
            <CardTitle className="text-white text-5xl font-bold mb-2">لقد خسرت</CardTitle>
            {isMultiplayer && (
              <p className="text-purple-200 text-lg">الخصم خمن الرقم السري في محاولات أقل</p>
            )}
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-red-800/50 to-pink-800/50 p-6 rounded-xl border border-red-400/30">
              <p className="text-red-200 text-lg mb-2">محاولاتك</p>
            ...
            <div className="bg-gradient-to-br from-red-800/50 to-pink-800/50 p-6 rounded-xl border border-red-400/30">
              <p className="text-red-200 text-lg mb-2">الوقت المستغرق</p>
            ...
            <div className="bg-gradient-to-br from-red-800/50 to-pink-800/50 p-6 rounded-xl border border-red-400/30">
              <p className="text-red-200 text-lg mb-2">الرقم السري {isMultiplayer ? "للخصم" : "كان"}</p>
